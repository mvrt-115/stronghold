...
public class DriveInterpreter {
  ...
  private static DoubleFunction<Double> limiter = limiter(-1.0, 1.0);
  ...
  private static double wheelDeadband = 0.01;
  private static double throttleDeadband = 0.02;

  private static DoubleFunction<Double> limiter(double minimum, double maximum) {
    if (maximum < minimum) {
  ...
  public static DriveSignal austinDrive2(double throttle, double wheel, boolean quickturn) {
