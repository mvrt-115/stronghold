...
public class Climber extends Subsystem {
  ...
  public Climber() {
    ...
    leftArm = new DoubleSolenoid(Constants.kPcmId,
            Constants.kLeftArmSolenoidA, Constants.kLeftArmSolenoidB);
    rightArm = new DoubleSolenoid(Constants.kPcmId,
            Constants.kRightArmSolenoidA, Constants.kRightArmSolenoidB);

    brake = new DoubleSolenoid(Constants.kPcmId,
            Constants.kClimberBrakeA, Constants.kClimberBrakeB);
  }
