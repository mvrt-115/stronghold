...
public class DriveStraightWithPID extends PIDCommand {
   ...
   * @param joystick
  */
  public DriveStraightWithPID(boolean joystick) {
   ...
   * @param joystick
   */
  public DriveStraightWithPID(double speed, boolean joystick) {
