...
public class DriveTurnPid extends Command {
  ...
  public DriveTurnPid(double degrees, boolean innerLoop) {
    requires(Robot.drive);

    controller = new SynchronousPid(Constants.kDriveTurnKp,
